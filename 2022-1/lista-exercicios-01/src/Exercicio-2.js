...
function main() {
  ...
  circleGeometry.setAttribute(
    "position",
    new THREE.Float32BufferAttribute(circleVert, 3)
  );
  circleGeometry.setAttribute(
    "color",
    new THREE.Float32BufferAttribute(colorCircle, 3)
  );
  ...
  heartGeometry.setAttribute(
    "position",
    new THREE.Float32BufferAttribute(heartVert, 3)
  );
  heartGeometry.setAttribute(
    "color",
    new THREE.Float32BufferAttribute(colorHeart, 3)
  );
  ...
  astroidGeometry.setAttribute(
    "position",
    new THREE.Float32BufferAttribute(astroidVert, 3)
  );
  astroidGeometry.setAttribute(
    "color",
    new THREE.Float32BufferAttribute(colorAstroid, 3)
  );
