...
function geraAstroid(){
	...
	astroidGeometry.setAttribute('position', new THREE.Float32BufferAttribute(positions, 3))
	astroidGeometry.setAttribute('color', new THREE.Float32BufferAttribute(colors, 3))
